...
<html>
    ...
    <body oncontextmenu="return false">
        ...
        <#if from = "touch">
            ...
            <div style="text-align: center;font-size:36px;font-weight: bold;">长辛店镇李家峪村棚改项目安置及房源使用情况</div>
            ...
            <div style="text-align:center;font-size:32px;font-weight:bold;"><span >预计：总计1188套</span></div>
        </div>
        ...
        <script type="text/javascript">
                    ...
                    type: 'column'
                            ...
                            xAxis: {
                            categories: ['一居室55', '二居室70', '二居室75', '二居室80', '二居室85', '三居室110'],
                                    title: {
                                    text: '居室'
                                    }
                            },
