...
<#if from?? >
  ...
  <div style='margin-top: 50px;color:#0F0;font-size:70px; font-family:"黑体";font-weight:bold;text-align: center;'>
      距预签约期限达到85%剩余户数：<span style="color: red">&nbsp;${wqy?default(50)}户</span>
    </div>
 <div style='margin-top: 50px;color:#0F0;font-size:70px; font-family:"黑体";font-weight:bold;text-align: center;'>
      距预签约期限结束：2017年8月5日 24:00:00点整
    </div>
    <div style='margin-top: 40px;color:#0F0;font-size:70px; font-family:"黑体";font-weight:bold;text-align: center;'>
        仅剩<span id="timeDate2" style="color: #0F0"></span>天<span id="times2"
                                                                 style="color:#0F0; width:230px !important;"></span>
    </div>
...
<script type="text/javascript">
    ...
    function createtime(timeDate, times) {
        ...
        var grt = new Date("08/06/2017 00:00:00");
