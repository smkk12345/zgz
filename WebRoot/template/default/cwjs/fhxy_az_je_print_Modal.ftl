...
<div class="modal-body center">
    <div class="container-fluid fhfa-rdjg-print-con"  id="xy-print" >
        <table class="table table-bordered" style="margin-bottom:0px;font-family: '宋体';font-size: 6px !important">
            <tr>
                <td class=""colspan="11"  style="font-weight:bold;" class="center">（李家峪）村宅基地房屋“安置房补偿”方式金额审查表（ ${bean.section}  ）标段</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="" >${bean.zjdarea?c?default("")}</td>
                <td class="" >身份证</td>
            ...
            <tr>
                ...
                <td class="">${bean.fwarea?c?default("")}</td>
