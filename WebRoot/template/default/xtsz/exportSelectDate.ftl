...
<div class="modal-body">
    <div class="alert alert-danger mb20">确认进行粮食出仓操作，此操作无法撤回!</div>
    <form>
       <div class="aoJianGroup clearfix"> 
            <label class='fl control-label required'>出仓时间:</label>
            <div class="aoJianGroup fl">
                <span style="position: relative; z-index: 9999;"><input type='text' class='form-control ml0 dmDate width-200px required' name='outputTime'  placeholder='出仓时间'/></span>
                <div class="cl"></div>
            </div>
        </div>
