...
<div class="container-fluid rhjc">
    ...
    <div class="top-ation mb10 clearfix">
        ...
        <div class="fl">
            <form  action="${BASE_PATH}jfdj/cfdj_0.action" accept-charset="UTF-8" method="post" >
    ...
    <div id="yu-pager" class="fl mb20">
        ...
        <#if recordCount??>
        <@p.pager pageNo=pageNo pageSize=pageSize recordCount=recordCount toURL="cfdj_0.action" 
...
<script type="text/javascript">
    ...
    function confirmcf(btn) {
        if (yu_confirm("您确认已经拆房？")) {
            ...
            $.ajax({
                ...
                dataType: "json",
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    location.href = "${BASE_PATH}" + "/jfdj/cfdj_0.action";
                },
                success: function (response) {
                    location.href = "${BASE_PATH}" + "/jfdj/cfdj_0.action";
                }
