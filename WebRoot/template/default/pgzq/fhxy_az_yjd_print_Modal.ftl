...
<!--                <td class="">${bean.kzzjdqwbcj?default(0)}</td>-->
            ...
            <tr>
                ...
                <td class="" >${bean.zjdttzj?default("")}</td>
                <td class="" colspan=5>宅基地腾退补偿总价抵扣购房款余额</td>
                <td class="">${bean.jshk?default("")}</td>
            </tr>
            <tr>	
            ...
            <tr>
                ...
                <td class="" colspan=3 rowspan=14></td>
            </tr>
            <tr>
                <td class="">2</td>
            ...
            <tr>
                <td class="">8</td>
                <td class=""  colspan=2>期房补助费</td>
                <td class=""  colspan=2>（总购房款10%）</td>
            ...
            <tr>
                <td class="">4</td>
                <td class=""  colspan=2>优惠指标未选满</td>
                <td class=""  colspan=2>（6000元㎡）</td>
                <td class="" colspan=2>${bean.yhzbwxmbc?default("/")}</td>
            </tr>                 
        </table>
    </div>
</div>
