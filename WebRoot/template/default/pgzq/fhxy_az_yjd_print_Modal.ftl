...
<div class="modal-body center">
    <div class="container-fluid fhfa-rdjg-print-con"  id="xy-print" >
        <table class="table table-bordered" style="margin-bottom:0px;font-family: '宋体';font-size: 6px !important">
            <tr>
                <td class="" style="font-weight:bold;font-size:18px;" colspan="11" >李家峪村宅基地“安置房补偿方式”第（ ${bean.section}  ）标段腾退补偿总价预结单</td>
            </tr>
            <tr>
        ...
        <table class="table table-bordered" style="margin-bottom:0px;font-family: '宋体';font-size: 6px !important">
            ...
            <tr>
                ...
                <td class="" colspan=1>${bean.pgzcqyjl?c?default("0")}</td>
            ...
            <tr>
                ...
                <td class="">备注</td>
                <td class=""  colspan=5>${bean.remark?default("/")}</td>
            </tr> 
        </table>
        <table class="table table-bordered" style="margin-bottom:0px;font-family: '宋体';font-size: 6px !important">
            <tr>	
