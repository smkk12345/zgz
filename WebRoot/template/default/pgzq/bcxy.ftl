...
<div class="container-fluid rhjc">
    <ul class="nav nav-pills menu mb5 clearfix">
        ...
        <#if role.roleAuthority[7]=="2">
         <a class="btn btn-info btn-group-sm pull-left dropdown-toggle YL-ModalClick" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-url='${BASE_PATH}bcxy_add_Modal.action'  title="点击登记信息"><span class="glyphicon glyphicon-plus white"></span> 登记</a>
