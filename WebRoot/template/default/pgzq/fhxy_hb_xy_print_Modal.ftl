    ...
    <body>
        ...
        <div class="modal-body center">
              <div class="content xy-print-con" id="xy-print">
                ...
                <p class="contex-1" >
                    &nbsp;&nbsp;&nbsp;&nbsp;6.1 乙方应在本协议生效且经项目审计部门审核通过后20日内完成腾退搬迁等事项。乙方应在腾退前结清所有资源欠费（含乙方使用的水、电等费用），确保房屋和附属物内无任何人员和财产（即房屋和附属物完全具备拆除条件），并将所有房屋及附属物的钥匙交给甲方，由拆除公司验收合格后，甲方认定乙方腾退完毕。<br/> 
                    &nbsp;&nbsp;&nbsp;&nbsp;6.2 乙方不得拆除原房屋(包含全部未被认定房屋)中房屋设备和建筑材料,并负责所有人员按期搬迁.未搬迁的,乙方承担未按期搬迁的相关责任。<br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;6.3 乙方承诺：在向甲方交付被腾退房屋后，乙方不再对该被腾退房屋享有并主张任何权利。
                </p>
