    ...
    <body>
        ...
        <div class="xy-print-con" id="xy-print">
            ...
            <p class="contex-1">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;8.3
                乙方宅基地腾退补偿总价款不足以支付定向安置房购房款的，甲方将乙方宅基地腾退补偿总价直接支付给定向安置房建设主体，甲方不再向乙方支付宅基地腾退补偿总价。乙方应按其所签署的《北京市定向安置房认购协议》所约定的期限向定向安置房建设主体补交剩余定向安置房购房款  
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;8.4
                乙方同意在甲方指定银行为双方办理宅基地腾退补偿总价付款业务及定向安置房购房款收款业务的支付凭证或单据上签字（盖章）。如乙方在办理宅基地腾退补偿总价款领取和定向安置房购房款的支付手续过程中拒绝在相关支付凭证或单据上签字，甲方和指定银行有权终止宅基地腾退补偿总价的发放。<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;8.5
