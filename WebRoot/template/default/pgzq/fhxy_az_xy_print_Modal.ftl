...
<html>
    ...
    <body>
        ...
        <div class="xy-print-con" id="xy-print">
            ...
            <p class="contex-1">
                &nbsp;&nbsp;&nbsp;&nbsp;8.1  本协议生效后，甲方应当向乙方支付被腾退宅基地腾退补偿总价人民币<u style="background-color:#F2F2F2;">&nbsp;&nbsp;${bean.zjdttzj?c?default("/")}&nbsp;&nbsp;</u>元（大写人民币：<u>&nbsp;&nbsp;${bean.dxzjdttzj?default("/")}&nbsp;&nbsp;</u>）。根据乙方签署的《北京市定向安置房认购协议》相关约定，乙方应向定向安置房建设主体支付定向安置房购房款共计
