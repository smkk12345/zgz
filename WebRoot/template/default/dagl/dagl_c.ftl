...
<!--                <button class="btn btn-primary btn-xs glyphicon glyphicon-export">导出</button>-->
        ...
        <table  class="table table-bordered table-hover">
	        ...
	        <tr id="${ROW.id}">
	            ...
	            <td>
	                <button type="button" class="btn btn-success btn-xs ml10 YL-ModalClick glyphicon glyphicon-min"
	                        title=''
	                        data-url="${BASE_PATH}dagl/DAGL_dagl_model.action?housebasicid=${ROW.housebasicid}"></button>
	            </td>
	        </tr>
	        </#list>
    	</#if>
        ...
        <div id="yu-pager" class="fl mb20">
            ...
            <#if recordCount??>
            <@p.pager pageNo=pageNo pageSize=pageSize recordCount=recordCount toURL="/dagl/list.action" 
