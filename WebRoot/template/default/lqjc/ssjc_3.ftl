...
<div class="ssjc_3 container-fluid  clearfix">
    <#if chartXAxis??>
    ...
    <div  class="menu mt20 clearfix pull-right ">
        ...
        <div class="form-group clearfix pull-right ml5">
            <select class="form-control width-80px pull-right bold" id="WSS-Select">
                ...
                <option selected='selected' value="${BASE_PATH}lqjc/ssjc_3.action">湿度</option>
    ...
    <div  class="menu mt10 clearfix fl">
        <div class="form-group fl yu-switch">
            <ul class="clearfix bootstrap-switch-mini">
                ...
                <li class="base-sline">粮堆均湿：<input  type="checkbox" name="switch" value="B1" checked="checked"></li>
                <li class=" base-sline">仓湿：<input  type="checkbox" name="switch" value="B2" checked="checked"></li>
                <li class="base-sline">外湿：<input  type="checkbox" name="switch" value="B3" checked="checked"></li>
    ...
    <script type="text/javascript">
                ...
                function getChartData(ids, startDateStr, endDate, grainId) {
                    var url = '${BASE_PATH}lqjc/getChartData.action?oType=' + "sd";
                    $.ajax({
                        type: "POST",
                        url: url,
                        dataType: "json",
                        ...
                        success: function (response) {
                            ...
                            if (curChartXAxis != null) {
                                CallChart('', curChartXAxis, curChartSeries, "平均湿度曲线分析图", "（最近监测时间：${CommenDate.RecentDate}）", "湿度(%)");
                            } else {
                                alert("此时间段没有粮情数据！");
                            }
                        }
