...
<div class="modal-body ">
    <div class="container-fluid rhjc-print-con" id="xy-print">
        <div class="title" style="margin-top: 5px;">李家峪村宅基地腾退拟定基本信息一览表</div>
        ...
        <div class="mt10 mb20 contex-1 container-fluid title1" >
            5. 认定房屋补偿面积：<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>平方米
        </div>
    </div>
