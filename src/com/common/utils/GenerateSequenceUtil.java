...
public class GenerateSequenceUtil {
    ...
    public static synchronized String generateSequenceNo() {
        ...
        StringBuffer sb = new StringBuffer("zy");
    ...
    /**
     * 之云-云图Number：时间格式生成序列
     * @return String
     */
    public static synchronized String generateSequenceNo2() {
    	 
        Calendar rightNow = Calendar.getInstance();
 
        StringBuffer sb = new StringBuffer("ZY-Cloud");
